...
def run():
    advertisement = 'Stock Market Brief: Wednesday - Stimulus vs. iPhone 12 Analogy https://market-brief.blogspot.com/2020/10/wednesday-stimulus-vs-iphone-12-analogy.html?spref=tw '
    ...
    for url in tickerConversations:   
        ...
        postInYahooConversation(driver, advertisement, url)
