...
def postInYahooConversation(driver):
...
def run():
    advertisement = 'Friday - Stock Market Brief :  https://market-brief.blogspot.com/2020/09/friday-rollercoaster.html'
    ...
    for url in tickerConversations:   
        ...
        time.sleep(t0)  
        print(i, url)
        postInYahooConversation(driver, advertisement)
        time.sleep(t)         
        t0 = 5
        i += 1
