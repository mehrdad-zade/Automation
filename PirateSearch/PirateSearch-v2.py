...
def UI():
    ...
    master = Tk()
    master.title("Search Your Movie on Pirate Websites") 
    ...
    def callback():
        searchTorrent(e.get()) # This is the text you may want to use later
    
    b = Button(master, text = "Pirate Search", width = 10, command = callback)
    b.pack()
    
    mainloop()  
        
#run this script    
UI() #searchTorrent which is the main functionality is called from the UI       
